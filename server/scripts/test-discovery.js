...
async function runTests() {
  try {
    ...
    assert(Array.isArray(defaultCities) && defaultCities.length > 0, "Empty query returns cities list");
    ...
    assert(liveImg.imageUrl.includes("images.pexels.com/photos/99999/"), "Live Pexels returns image");
