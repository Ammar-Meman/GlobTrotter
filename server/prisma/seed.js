        ...
        create: [
          ...
          // Stop 2: Rome (Days 4-7: Sept 4 - Sept 7)
          {
            ...
            activities: {
              create: [
                {
                  name: "Flight: Paris to Rome (CDG -> FCO)",
                  type: "Flight",
                  category: "transport",
                  cost: 110,
                  duration: 130,
                  description: "Morning flight connecting Paris to Rome.",
                  imageUrl: "https://images.unsplash.com/photo-1436491865332-7a61a109cc05?auto=format&fit=crop&w=800&q=80",
                  scheduledAt: new Date("2026-09-04T08:30:00.000Z"),
                  order: 0,
                },
                {
                  name: "Colosseum & Roman Forum Exploration",
                  type: "Historical Landmark",
                  category: "activity",
                  cost: 28,
                  duration: 210,
                  description: "Priority entrance ticket and audio tour.",
                  imageUrl: "https://images.unsplash.com/photo-1552832230-c0197dd311b5?auto=format&fit=crop&w=800&q=80",
                  scheduledAt: new Date("2026-09-05T11:00:00.000Z"),
                  order: 1,
                },
                {
                  name: "Trastevere Authentic Pasta Tasting",
                  type: "Food Tour",
                  category: "meal",
                  cost: 45,
                  duration: 90,
                  description: "Handmade Cacio e Pepe in historic Trastevere.",
          ...
          // Stop 3: Barcelona (Days 7-10: Sept 7 - Sept 10)
          {
            ...
            activities: {
              create: [
                {
                  name: "High-speed Train: Rome to Barcelona",
                  type: "Train",
                  category: "transport",
                  cost: 95,
                  duration: 240,
                  description: "Scenic coastal rail journey into Catalonia.",
                ...
                {
                  name: "Sagrada Familia Architecture Tour",
                  type: "Architectural Tour",
                  category: "activity",
                  cost: 32,
                  duration: 150,
                  description: "Antoni Gaudí's unfinished masterpiece with tower access.",
                  imageUrl: "https://images.unsplash.com/photo-1583422409516-2895a77efded?auto=format&fit=crop&w=800&q=80",
                  scheduledAt: new Date("2026-09-08T15:00:00.000Z"),
                  order: 1,
                },
                {
                  name: "Barceloneta Beachside Hotel",
                  type: "Resort Hotel",
                  category: "stay",
                  cost: 260,
                  duration: 1440,
                  description: "Seafront accommodation with rooftop pool.",
                  imageUrl: "https://images.unsplash.com/photo-1520250497591-112f2f40a3f4?auto=format&fit=crop&w=800&q=80",
                  scheduledAt: new Date("2026-09-09T13:00:00.000Z"),
                  order: 2,
                },
              ],
            },
